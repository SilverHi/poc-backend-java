        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 flex items-center space-x-2 cursor-pointer ${
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 flex items-center space-x-2 ${
                currentView === AppView.EDITOR
                  ? 'bg-gradient-to-r from-gray-900 to-gray-800 text-white shadow-lg transform scale-105'
                  : selectedWorkflow
                  ? 'text-gray-700 hover:text-gray-900 hover:bg-white/80 hover:shadow-md hover:scale-105 cursor-pointer'
