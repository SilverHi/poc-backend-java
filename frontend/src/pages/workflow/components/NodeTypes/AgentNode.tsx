      ...
      <div className="flex items-center justify-between space-x-2 relative z-10">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="ml-2 p-1 text-white hover:text-cyan-100 hover:bg-white/30 hover:shadow-lg rounded transition-all duration-200 backdrop-blur-sm border border-white/20 hover:border-white/40 cursor-pointer"
            title="Configure Agent"
          >
            <svg className="w-4 h-4" fill="none" stroke="#4f7ae9" strokeWidth={2.5} viewBox="0 -1 24 24">
